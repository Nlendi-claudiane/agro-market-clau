          ...
          <div class="bg-secondary py-5 my-5 rounded-5" style="background: url('images/bg-leaves-img-pattern.png') no-repeat;">
            ...
            -->
                <div class="col-md-12 p-5">
                  <form>
                    <div class="mb-3">
                      <label for="name" class="form-label">Adresse electronique</label>
                      <input type="text"
                        class="form-control form-control-lg" name="adress" id="adresse" placeholder="Adresse">
                    </div>
                    <div class="mb-12">
                    ...
                    <div class="form-check form-check-inline mb-3">
                        <a href="enregistrement.html" >Creer un compte ?</a>
