...

 {
   ...
   if(!empty($newsletter) && preg_match("/[A-Za-z ] {4,30}/",$newsletter))
   
    {
        ...
        $query = "insert into newsletter values (NULL, '$newsletter')";
        $conn->exec($query);
        }
    } 
 ?>
      ...
      <div class="offcanvas-body">
        <div class="order-md-last">
          <h4 class="d-flex justify-content-between align-items-center mb-3">
            <span class="text-primary">Ma carte</span>
          ...
          <button class="w-100 btn btn-primary btn-lg" type="submit">Continuer l'achat</button>
        </div>
      </div>
    </div>
    ...
    <header>
      <div class="container-fluid">
        <div class="row py-3 border-bottom">
            ...
            <div class="search-bar row bg-light p-2 my-2 rounded-4">
              ...
              <div class="col-11 col-md-7">
                <form id="search-form" class="text-center" action="index.html" method="post">
                  <input type="text" class="form-control border-0 bg-transparent" placeholder="Recherches" />
                </form>
              </div>
          ...
          <div class="col-sm-'' col-lg-4 d-flex justify-content-end gap-5 align-items-center mt-4 mt-sm-0 justify-content-center justify-content-sm-end">
              ...
              <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                ...
                <div class="offcanvas-body">
                  <ul class="navbar-nav justify-content-end menu-list list-unstyled d-flex gap-md-3 mb-0">
                    ...
                    <li class="nav-item">
                        <a href="enregistrement.php" class="nav-link">Inscription</a>
                      </li>
                      <li class="nav-item">
          ...
          <div class="col-md-12">
            <div class="banner-blocks">
                ...
                <div class="swiper main-swiper">
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <div class="row banner-content p-5">
                        <div class="content-wrapper col-md-7">
                          ...
                          <h3 class="display-4">Fresh Smoothie</h3>
                          <p>Jus faite à basse de fruit.</p> 
                        </div>
                    ...
                    <div class="swiper-slide">
                      <div class="row banner-content p-5">
                        <div class="content-wrapper col-md-7">
                          <div class="categories mb-3 pb-3">100% Naturel</div>
                          <h3 class="banner-title">Heinz Tomato Ketchup</h3>
                          <p>Ketchup à basse des tomates.</p>                          
                        </div>
                        <div class="img-wrapper col-md-5">
              ...
              <div class="banner-ad bg-success-subtle block-2" style="background:url('images/ad-image-1.png') no-repeat;background-position: right bottom">
                <div class="row banner-content p-5">
                  <div class="content-wrapper col-md-7">
                    <div class="categories sale mb-3 pb-3">20% de réduction</div>
                    <h3 class="banner-title">Fruits & Légumes</h3>
                  </div>
                </div>
              </div>

              <div class="banner-ad bg-danger block-3" style="background:url('images/thumb-raspberries.png') no-repeat;background-position: right bottom">
                <div class="row banner-content p-5">
                  <div class="content-wrapper col-md-7">
                    <div class="categories sale mb-3 pb-3">15% de réduction</div>
                    <h3 class="item-title">Fraise</h3>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="tabs-header d-flex justify-content-between border-bottom my-5">
                ...
                <nav>
                  <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    <a href="#" class="nav-link text-uppercase fs-6 active" id="nav-all-tab" data-bs-toggle="tab" data-bs-target="#nav-all">Tout</a>
                    <a href="#" class="nav-link text-uppercase fs-6" id="nav-fruits-tab" data-bs-toggle="tab" data-bs-target="#nav-fruits">Fruits</a>
                    <a href="#" class="nav-link text-uppercase fs-6" id="nav-juices-tab" data-bs-toggle="tab" data-bs-target="#nav-juices">Jus</a>
                  </div>
                </nav>
              </div>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="section-header d-flex flex-wrap justify-content-between my-5">
              ...
              <h2 class="section-title">Le plus vendus</h2>

              <div class="d-flex align-items-center">
                <a href="#" class="btn-link text-decoration-none">Voir la liste →</a>
                <div class="swiper-buttons">
            ...
            <article class="post-item card border-0 shadow-sm p-3">
              ...
              <div class="card-body">
                ...
                <div class="post-header">
                  <h3 class="post-title">
                    <a href="#" class="text-decoration-none">Mangez au moins cinqs fruits et légumes chaques jour</a>
                  </h3>
                </div>
              </div>
            </article>
          ...
          <div class="col-md-4">
            <article class="post-item card border-0 shadow-sm p-3">
              ...
              <div class="card-body">
                ...
                <div class="post-header">
                  <h3 class="post-title">
                    <a href="#" class="text-decoration-none">Haricot</a>
                  </h3>
                </div>
              </div>
            </article>
          ...
          <div class="col-md-4">
            <article class="post-item card border-0 shadow-sm p-3">
              ...
              <div class="card-body">
                ...
                <div class="post-header">
                  <h3 class="post-title">
                    <a href="#" class="text-decoration-none">Mangez régulierement du chou et du légumes</a>
                  </h3>
                </div>
              </div>
            </article>
