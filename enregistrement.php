            ...
            <!--
                <div class="col-md-6 p-5">
                    <div class="section-header">
                      <h2 class="section-title display-4">Obtenez <span class="text-primary">25% de réduction</span> sur votre premier achat.</h2>
                    </div>
                  </div>
            -->
                <div class="col-md-12 p-0">
                  <form>
                    <div class="mb-6">
                      ...
                      <input type="text"
                        class="form-control form-control-lg" name="nom" id="adresse" placeholder="Noms">
                    </div>

                    <div class="mb-6">
                        <label for="name" class="form-label">Prenom</label>
                        <input type="text"
                          class="form-control form-control-lg" name="prenom" id="adresse" placeholder="Prenom">
                      </div>

                      <div class="mb-6">
                        <label for="name" class="form-label">Portable</label>
                        <input type="text"
                          class="form-control form-control-lg" name="adress" id="portable" placeholder="Portable">
                      </div>

                      <div class="mb-6">
                        <label for="name" class="form-label">Email</label>
                        <input type="text"
                          class="form-control form-control-lg" name="email" id="email" placeholder="Email">
                      </div>

                    <div class="mb-6">
                      <label for="" class="form-label">Mot de passe</label>
                      <input type="email" class="form-control form-control-lg" name="email" id="email" placeholder="Mot de passe">
                    </div>
                    <div class="mb-6">
                    ...
                    <div class="col-md-12">
                        <button type="submit" class="btn btn-dark btn-lg">S'enregistré</button>
                    </div>
                  </form>
                </div>
              </div>
