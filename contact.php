      ...
      <section class="py-5">
        <div class="container-fluid">
          <div class="bg-secondary py-5 my-5 rounded-5" style="background: url('images/bg-leaves-img-pattern.png') no-repeat;">
                ...
                <div class="col-md-12 p-5">
                    <form>
						<div class="row">
							...
							<div class="col-sm-4">
								<input class="form-control" type="text" placeholder="Portable">
							</div>
						</div>
						<br>
						<div class="row">
							<div class="col-sm-12">
								<textarea placeholder="Laissez votre message..." class="form-control" rows="9"></textarea>
							</div>
						</div>
						<br>
						<div class="row">
							<div class="col-sm-6">
								<label class="checkbox"><input type="checkbox"> Enregistrement à la newsletter</label>
							</div>
            ...
            $message="Ce mesage vous a été envoyé depuis la page contact.
            Nom : ". $_POST['nom'] ."
            Email : ". $_POST['email'] ."
            Portable : ". $_POST['num'] ."
            Message : ".$_POST['message'];
            $retour = mail('merdimoke040@gmail.com', $message, 'From: merdimoke040@gmail.com' . "\r\n" . 'Reply-to: ' . $_POST['email']);
            if($retour)
